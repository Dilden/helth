...
<div class="grid-col-2 grid-rows-[1fr .5fr] gap-x-5 grid">
	<p class="col-start-1 col-end-3">{message}</p>
	<button class="text-2xl col-start-1 col-end-1" title="Yes" onclick={yes}>Yes</button>
	<button class="text-2xl col-start-2 col-end-2" title="No" onclick={no}>No</button>
</div>
